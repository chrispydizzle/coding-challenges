    ...
    public class WordLadder
    {
        ...
        private int FindLength(string currentWord, string endWord, HashSet<string> wordList)
        {
            ...
            for (int i = 0; i < wordLength; i++){
                // create our initial distancew
                string changeTarget = currentWord.Remove(i, 1).Insert(i, "*"); // word.Substring(0, i) + '*' + word.Substring(i + 1, wordLength);
                connections.Add(changeTarget, new HashSet<string>());
            }
